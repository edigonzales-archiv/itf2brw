...
final EXCELFILENAME = "flaechenmass_sdr_proj"
final SHAPEFILENAME = "flaechenmass_sdr_proj"
...
sql = """SELECT b.nummer, b.nbident, b.art_txt, ST_Area(a.geometrie) as flaeche, round(ST_Area(a.geometrie)::numeric, 0)::integer as flaeche_gerundet, a.flaechenmass,  (a.flaechenmass - round(ST_Area(a.geometrie)::numeric, 0)::integer)::integer as differenz, a.geometrie, a.gem_bfs, a.los, a.lieferdatum, current_date as datum FROM
av_dm01avch24d_lv03.liegenschaften_projselbstrecht as a, 
av_dm01avch24d_lv03.liegenschaften_projgrundstueck as b
...
XSSFSheet sheet = workbook.createSheet("flaechenvergleich_sdr_proj_1");
