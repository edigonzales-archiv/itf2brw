...
SELECT c.nummer, c.nbident, c.flaeche_gerundet as flaeche_lv03, d.flaeche_gerundet as flaeche_lv95, (d.flaeche_gerundet - c.flaeche_gerundet) as flaeche_diff, c.gem_bfs, c.los, c.lieferdatum FROM
(
